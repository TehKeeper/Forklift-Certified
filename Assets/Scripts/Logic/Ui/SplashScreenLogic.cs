...
namespace Logic.Ui {
    /// <summary>Game start black screen fadeOut</summary>
    public class SplashScreenLogic : MonoBehaviour {
        ...
        private async UniTask Appear() {
            ...
            //but c'mon, this script is only 32 rows long. In a perfect world there is separate view and manager, but 
            //unfortunately we live in a cursed timeline where merries is 750 roubles per kilo and 1C: Производство is a thing
            OnSceneReady?.Invoke();
        }
    }
}
